...
CREATE POLICY "behavioral_baselines_select_all" 
ON public.behavioral_baselines 
FOR SELECT 
USING (TRUE);

CREATE POLICY "behavioral_baselines_insert_all" 
ON public.behavioral_baselines 
FOR INSERT 
WITH CHECK (TRUE);

CREATE POLICY "behavioral_baselines_update_all" 
ON public.behavioral_baselines 
FOR UPDATE 
USING (TRUE);

CREATE POLICY "behavioral_baselines_delete_all" 
ON public.behavioral_baselines 
FOR DELETE 
USING (TRUE);
