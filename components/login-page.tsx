          ...
          {modalView === "none" && (
            <div className="p-6">
              ...
              <div className="mt-6 text-center space-y-3">
                <p className="text-gray-600 text-sm">New to Chase?</p>
                <Button
                  onClick={() => setModalView("signup")}
                  variant="outline"
                  className="w-full border-[#117aca] text-[#117aca] hover:bg-blue-50"
                >
                  Create an account
                </Button>
              </div>
              ...
              <div className="mt-6 p-4 bg-blue-50 rounded-xl">
                <h3 className="font-semibold text-gray-900 mb-3 text-sm">Security Features</h3>
                <ul className="text-xs text-gray-600 space-y-2">
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-green-600" /> 256-bit encryption
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-green-600" /> Multi-factor authentication
                  </li>
                  <li className="flex items-center gap-2">
                    <Check className="w-4 h-4 text-green-600" /> Real-time fraud monitoring
                  </li>
                </ul>
              </div>
            </div>
